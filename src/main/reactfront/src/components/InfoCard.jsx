  ...
  const cards = [
    {
      ...
      color: "bg-cardBlue", // 밝고 채도 높은 파란색
      link: "#",
    },
    {
      title: "연구 과정",
      subtitle: "Research Curriculum",
      color: "bg-cardOrange", // 밝고 채도 높은 주황색
      link: "#",
    },
    {
      title: "참여기업",
      subtitle: "Participating Companies",
      color: "bg-cardGreen", // 밝고 채도 높은 초록색
      link: "#",
    },
  ];
  ...
  return (
    <div className="flex justify-center items-end gap-[73px] pb-[100px]">
      {cards.map((card, index) => (
        <div
          key={index}
          className={`${card.color} relative w-[316.92px] h-[400px] text-white text-center rounded-lg shadow-lg group`}
        >
          <div className="absolute inset-0 bg-black opacity-30 rounded-lg group-hover:opacity-50 transition"></div>
